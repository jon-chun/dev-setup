...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/jonc/.vscode/extensions/anthropic.claude-code-2.0.35-darwin-arm64/resources/native-binary/claude --ripgrep'
fi
export PATH=/Users/jonc/code/sentimentarcs/.venv/bin\:/usr/local/texlive/2025/bin/universal-darwin\:/Users/jonc/.opencode/bin\:/Users/jonc/.bun/bin\:/Users/jonc/.nvm/versions/node/v22.19.0/bin\:/Users/jonc/.local/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Library/TeX/texbin\:/usr/local/go/bin\:/opt/homebrew/bin\:/Users/jonc/.cargo/bin\:/Applications/Ghostty.app/Contents/MacOS\:/Users/jonc/.lmstudio/bin
